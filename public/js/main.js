    ...
    var dtIntegration = function() {
        $.extend(true, $.fn.dataTable.defaults, {
            ...
            "oLanguage": {
                ...
                "sZeroRecords":    '<p style="text-align:center;">No se encontraron resultados</p>',
                "sEmptyTable":     '<p style="text-align:center;margin-bottom:0;">Ningún dato disponible en esta tabla</p>',
